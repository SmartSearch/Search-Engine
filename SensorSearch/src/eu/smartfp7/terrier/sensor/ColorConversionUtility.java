...
/**
 * A color conversion utility.
 * Implementation is based on the JS in 
 * <a href="http://name-of-color.com/color/camarone">http://name-of-color.com/color/camarone</a>
 *   
...
public class ColorConversionUtility {
	...
	/**
	 * Find the closest color name to given color specified in RGB.
	 * 
	 * @param rgb
	 * @return
	 */
	public static String findClosestColor(int rgb) {			
	    double min = 3 * Math.pow(256, 2) + 1;
	    String data = null;
	    for (String[] c: colorTable) {
	        String color = c[1];
	        if (color!=null) {
	            double df = rgbDistance(hexToRgb(c[0]), rgb);
	            if (df < min) {
	                min = df;
	                data = color;
	            }
	...
	private static double rgbDistance(int color1, int color2) {
	  ...
	  /**
	   *
	   * Convert a color into its hexadecimal format
	   *
	   * @param r red
	   * @param g green
	   * @param b blue
	   ...
	   */
	   public String toHex(int color) {
		  
		  int c[]= decode(color);
		  return  toHexValue(c[0]) + toHexValue(c[1]) + toHexValue(c[2]);
	  } 
	...
	public static void main(String[] args){
		  System.out.println(findClosestColor(2113600));
		  System.out.println(findClosestColor(4218976));
		  System.out.println(findClosestColor(4218976));
		  System.out.println(findClosestColor(2113664));
		  System.out.println(findClosestColor(12640480));
		  
	  }
	  private static String[][] colorTable = new String[][]{{"000000", "Black"},
			{"000080", "Navy Blue"},
			{"0000C8", "Dark Blue"},
			{"0000FF", "Blue"},
			{"000741", "Stratos"},
